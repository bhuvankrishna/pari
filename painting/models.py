...
class painting(Page):
    image = models.ForeignKey("core.AffixImage",
                              related_name="painting_for_image", null=True,
                              on_delete=models.SET_NULL)
    original_image_1 = models.ForeignKey("core.AffixImage",
                              related_name="original_image_1", null=True,
    ...
    search_fields = Page.search_fields + [
        ...
        index.FilterField('original_image_1'),
    ...
    content_panels = Page.content_panels + [
        ...
        ImageChooserPanel('original_image_1'),
